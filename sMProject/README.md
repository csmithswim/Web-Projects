Today's project is to make the back end programming for a social media website/app that will upload Users and Posts to a MongoDB server using CRUD methods.
